        ...
        with open(fileNameStats, 'w') as hFile2: # Use hfile to refer to the file object
            ...
            for n in range(0, nAmbient ):
                ...
                for m in range(0,n100msSamples):#number of 100ms measureents to record
                    ...
                    saveFileNameRawData = fileNameRawDataPrefix + "FurnaceTemp_"+ furnaceTempString +"AmbientTemp_" + str(setPointValue)   + ".csv"
                    ...
                    arrayOut = str(elapsedTime) + ","  + str(furnaceTempString) + "," + str(ambientSetTemp) + ","  + str(thermistorsignal) + "," + str(dCData) + "," + str(signalFAmp) + '\n'
                ...
                statsOut = str(elapsedTime) + ","  + str(peakToPeakSignal) + ","  + str(peakToPeakNoise) + "," + str(signalToNoise) + "," + str(ambientSetTemp) + "," + str(furnaceTempString) + "," + str(averageThermistor) + "," + str(averageDC)+  '\n'
                hFile2.write(statsOut)
