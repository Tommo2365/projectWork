    ...
    while (elapsedTimeHours < totalDurationHours):
        ...
        for n in range(0, nfurnace ):
            ...
            for k in range(0,spotNRepeats):
                ...
                brightMean2 = np.mean(brightValuesD2)
                darkMean2 = np.mean(darkValuesD2)
                ...
                if count == 0:
                    count = count + 1
                    arrayOut = "ElapsedTime" + "," + "furnaceSetTemp" + "," + "FurnaceGetTemp" + "," + "Spot Measured mean" + "," + "Spot Measured Stdev" + "," + "ThermistorTemp" + "," + "BrightMean" + "," + "DarkMean" + "," + "BrightMean2" +  "," + "DarkMean2" +  "\n"
                    hFile.write(arrayOut)

                print("Writing to csv file " + str(fileName) )
                arrayOut = str(elapsedTimeMins) +  "," + str(furnaceSetTemp) + ","  + str(currentfurnace) + "," + str(spotMeanValue) + "," + str(spotNoiseValue) + "," + str(thermistorTempMean) + "," + str(brightMean) + "," + str(darkMean) + "," + str(brightMean2) + "," + str(darkMean2) +   "\n"
                hFile.write(arrayOut)
